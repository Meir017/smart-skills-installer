...
public class SkillMatcherTests
{
    ...
    public void Match_ExactName_ReturnsMatch()
    {
        ...
        var entries = new[] { new RegistryEntry { MatchCriteria = ["Newtonsoft.Json"], SkillPath = "skills/json" } };
    ...
    public void Match_GlobPattern_ReturnsMatch()
    {
        ...
        var entries = new[] { new RegistryEntry { MatchCriteria = ["Microsoft.EntityFrameworkCore*"], SkillPath = "skills/ef" } };
    ...
    public void Match_NoMatch_ReturnsEmpty()
    {
        ...
        var entries = new[] { new RegistryEntry { MatchCriteria = ["OtherPackage"], SkillPath = "skills/other" } };
    ...
    public void Match_MultiplePatterns_MatchesAny()
    {
        ...
        var entries = new[] { new RegistryEntry { MatchCriteria = ["PackageA", "PackageB"], SkillPath = "skills/multi" } };
